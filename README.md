...
![Football Event Clipper dashboard](assets/Focus_Image.jpg)
...
[Watch the demo video]([assets/Demo.mp4](https://github.com/Rohan-Kumar-V/football-event-clipper/releases/download/v0.1.0/Demo.mp4))
